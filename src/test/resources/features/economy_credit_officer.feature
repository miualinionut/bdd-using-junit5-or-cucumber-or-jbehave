Feature: Bank Offers for economy credit officers
  Some details about this feature

  Scenario: Adding and removing usual customers for economy credit officer
  ...
  Scenario: Adding and removing VIP customers for economy credit officer
    Given there is a economy credit offer
